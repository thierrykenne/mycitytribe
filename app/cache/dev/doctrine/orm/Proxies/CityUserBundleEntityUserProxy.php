...
class CityUserBundleEntityUserProxy extends \City\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addMessages($message);
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'messages', 'nationality', 'about_me', 'sex', 'premium', 'num_question', 'num_answer', 'visit_goal', 'occupation', 'language', 'image', 'facebookId');
    }
